...
if __name__ == '__main__':
    ...
    device = 'cpu'
    if(args.use and args.use.lower() == 'gpu'):
    ...
    dist.init_process_group(backend=("nccl" if device == "cude" else "gloo"), world_size=1, rank=0)
    ...
    snap_model = nn.parallel.DistributedDataParallel(snap_model, device_ids=([0] if device == "cude" else None))
